...
function Simple() {
  ...
  const answersC = {
    ...
    keyboard: [
      "f=discount.any%2Crating.any%2C12085_6",
      "f=discount.any%2Crating.any%2C12079_6",
    ], //игровая,проводная
    priceKeyboard: [
  ...
  const createlink = () => {
    ...
    let hrefScreenC =
      "https://www.citilink.ru/search/?text=монитор&menu_id=162";
    let hrefHDDC =
    ...
    let hrefKeyboardC =
      "https://www.citilink.ru/search/?text=клавиатура&menu_id=6";
      ...
      >
        <div className="link-container">
          <div
            ...
            onClick={() => {
              window.open(
                "https://www.youtube.com/watch?v=aR9bbLI7qpQ",
                "_blank"
              );
            }}
          >
          ...
          <div
            className="link"
            onClick={() => {
              window.open("https://disk.yandex.ru/i/FyVmcw7i--PjKQ", "_blank");
            }}
          >
            400 ГБ жёсткого gachi-контента
      ...
      </Modal>
      {
        <form className="content__form">
          <ul className="list">
            ...
            <li className="list__item">
              <h3 className="list__item-title"> Для чего вам компьютер?</h3>
              <div className="list__check">
                <label>
                  <input
                    className={
                    ...
                    onChange={(event) => {
                      ...
                      setSettingsC((prevState) => ({
                        ...
                        screen: answersC.screen[2],
                        keyboard: answersC.keyboard[2],
                        mouse: answersC.mouse[2],
                      }));
                    }}
                  />
            ...
            <li className="list__item">
              <h3 className="list__item-title">
                {" "}
                Собираетесь ли вы обрабатывать большой объем данных на высокой
                скорости?
              </h3>
              <div className="list__check">
                <label>
